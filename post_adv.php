...
<body>
 ...
 <?php
      ...
      if(isset($_POST['POST']))
    {
      ...
      $sql_query = "INSERT INTO post_adv (post_id,supplier_id,crop_name,required_quantity,supplier_name,contact_number) VALUES('$post_id' , '$supplier_id' , '$crop_name' ,  '$required_quantity' , '$supplier_name' , '$contact_number')";
